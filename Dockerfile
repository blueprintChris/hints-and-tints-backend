...
# 1. aws ecr get-login-password --region eu-west-2 | docker login --username AWS --password-stdin 978544736059.dkr.ecr.eu-west-2.amazonaws.com
# 2. docker build . -t 978544736059.dkr.ecr.eu-west-2.amazonaws.com/hints-and-tints-backend
# 3. docker push 978544736059.dkr.ecr.eu-west-2.amazonaws.com/hints-and-tints-backend
# 4. login to putty -> docker stop 978544736059.dkr.ecr.eu-west-2.amazonaws.com/hints-and-tints-backend
# 5. docker stop  978544736059.dkr.ecr.eu-west-2.amazonaws.com/hints-and-tints-backend
# 8. docker pull 978544736059.dkr.ecr.eu-west-2.amazonaws.com/hints-and-tints-backend
